...
[![confirmed](https://img.shields.io/badge/confirmed-1345-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13556-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8382** | **3303** | **2007** | **13692** |
...
## 工作原理
> 数据截至快照 `20260923T214501Z`（2026-09-24 05:45:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260923T214501Z` (2026-09-24 05:45:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 23256 · 龄 752m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 13556"}
    D1 -->|"8382 / 3303"| E1["聚合 + README 分类统计"]
    D1 -->|"1871 环境类重试"| C1
...
- **🔌 Web UI 增强**（2834）— 可用 1285 · 不兼容 480 · 待定 253 · 未测 18 · 监测 798 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2220）— 可用 872 · 不兼容 415 · 待定 207 · 未测 23 · 监测 703 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2356）— 可用 784 · 不兼容 344 · 待定 180 · 未测 14 · 监测 1034 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（754）— 可用 249 · 不兼容 139 · 待定 53 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（704）— 可用 266 · 不兼容 109 · 待定 64 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（461）— 可用 171 · 不兼容 46 · 待定 25 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1394）— 可用 421 · 不兼容 163 · 待定 123 · 未测 7 · 监测 680 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（167）— 可用 34 · 不兼容 14 · 待定 8 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7550）— 可用 1823 · 不兼容 429 · 待定 267 · 未测 23 · 监测 5008 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260923T214501Z（2026-09-24 05:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8382 可用 · 3303 不兼容 · 1871 待定（共 13556 个，k8s agent 口径）|
