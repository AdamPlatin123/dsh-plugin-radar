...
[![confirmed](https://img.shields.io/badge/confirmed-1346-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13558-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8367** | **3289** | **2038** | **13694** |
...
## 工作原理
> 数据截至快照 `20260924T094501Z`（2026-09-24 17:45:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260924T094501Z` (2026-09-24 17:45:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 23453 · 龄 515m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1346"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13558"}
    D1 -->|"8367 / 3289"| E1["聚合 + README 分类统计"]
    D1 -->|"1902 环境类重试"| C1
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-24 13:01（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-24 13:01 (UTC+8).*
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 28752★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-24 13:01（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-24 13:01 (UTC+8).*
...
- **🛒 市场与管理**（322）— 可用 96 · 不兼容 28 · 待定 19 · 未测 12 · 监测 167 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2835）— 可用 1285 · 不兼容 476 · 待定 258 · 未测 18 · 监测 798 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2225）— 可用 873 · 不兼容 416 · 待定 210 · 未测 23 · 监测 703 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2354）— 可用 779 · 不兼容 343 · 待定 184 · 未测 14 · 监测 1034 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（754）— 可用 248 · 不兼容 139 · 待定 54 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（702）— 可用 264 · 不兼容 109 · 待定 64 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（461）— 可用 169 · 不兼容 47 · 待定 26 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1395）— 可用 421 · 不兼容 163 · 待定 124 · 未测 7 · 监测 680 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（167）— 可用 34 · 不兼容 14 · 待定 8 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7551）— 可用 1821 · 不兼容 427 · 待定 270 · 未测 23 · 监测 5010 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260924T094501Z（2026-09-24 17:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8367 可用 · 3289 不兼容 · 1902 待定（共 13558 个，k8s agent 口径）|
