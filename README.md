...
[![confirmed](https://img.shields.io/badge/confirmed-1353-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13583-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8308** | **3248** | **2163** | **13719** |
...
## 工作原理
> 数据截至快照 `20260926T211501Z`（2026-09-27 05:15:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260926T211501Z` (2026-09-27 05:15:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 24048 · 龄 215m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1353"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13583"}
    D1 -->|"8308 / 3248"| E1["聚合 + README 分类统计"]
    D1 -->|"2027 环境类重试"| C1
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-27 05:16（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-27 05:16 (UTC+8).*
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 6109★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3766★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 29076★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 2710★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui)** · 286★ — 自研 ANSI 渲染的极简终端 UI

### 👁 视觉与多模态（4）
*Vision & Multimodal (4)*

- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 4045★ — 生态第一个视觉插件，视觉工作流的基准方案
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 25047★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1815★ — 多代理团队编排
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[sandbase-harness](https://github.com/sandbaseai/sandbase-harness)** · 674★ — CMA 兼容开源 agent 运行时，任意模型可驱动
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[axern](https://github.com/cofy-x/axern)** · 66★ — AI agent 开源沙箱：不可信代码执行与持久服务

### 💻 编码与生产力（5）
*Coding & Productivity (5)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1730★ — 本地优先的 31 种编码工具 token 用量与成本追踪
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 4639★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 2222★ — 深海鲸鱼养成
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-27 05:16（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-27 05:16 (UTC+8).*
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 173★ — 完整逆向工程技能合集（85 个 SKILL.md）
...
- **🧠 记忆增强**（49）— 可用 15 · 不兼容 4 · 待定 5 · 未测 2 · 监测 23 — [明细](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（24）— 可用 11 · 不兼容 1 · 待定 2 · 未测 7 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（324）— 可用 97 · 不兼容 28 · 待定 19 · 未测 12 · 监测 168 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2842）— 可用 1272 · 不兼容 474 · 待定 279 · 未测 18 · 监测 799 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2228）— 可用 865 · 不兼容 414 · 待定 222 · 未测 23 · 监测 704 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2366）— 可用 787 · 不兼容 336 · 待定 190 · 未测 14 · 监测 1039 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（752）— 可用 244 · 不兼容 136 · 待定 59 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（703）— 可用 261 · 不兼容 110 · 待定 67 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（461）— 可用 168 · 不兼容 47 · 待定 27 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1390）— 可用 418 · 不兼容 158 · 待定 127 · 未测 7 · 监测 680 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（169）— 可用 36 · 不兼容 14 · 待定 8 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7581）— 可用 1835 · 不兼容 428 · 待定 278 · 未测 23 · 监测 5017 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260926T211501Z（2026-09-27 05:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8308 可用 · 3248 不兼容 · 2027 待定（共 13583 个，k8s agent 口径）|
