...
[![confirmed](https://img.shields.io/badge/confirmed-1353-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13571-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8315** | **3253** | **2139** | **13707** |
...
## 工作原理
> 数据截至快照 `20260926T094501Z`（2026-09-26 17:45:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260926T094501Z` (2026-09-26 17:45:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 23985 · 龄 3m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 13571"}
    D1 -->|"8315 / 3253"| E1["聚合 + README 分类统计"]
    D1 -->|"2003 环境类重试"| C1
...
- **🔌 Web UI 增强**（2841）— 可用 1272 · 不兼容 473 · 待定 279 · 未测 18 · 监测 799 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2227）— 可用 864 · 不兼容 415 · 待定 221 · 未测 23 · 监测 704 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2363）— 可用 788 · 不兼容 335 · 待定 191 · 未测 14 · 监测 1035 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（752）— 可用 244 · 不兼容 136 · 待定 59 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（703）— 可用 262 · 不兼容 110 · 待定 66 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（461）— 可用 168 · 不兼容 47 · 待定 27 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1389）— 可用 418 · 不兼容 158 · 待定 126 · 未测 7 · 监测 680 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（169）— 可用 36 · 不兼容 14 · 待定 8 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7573）— 可用 1835 · 不兼容 429 · 待定 275 · 未测 23 · 监测 5011 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260926T094501Z（2026-09-26 17:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8315 可用 · 3253 不兼容 · 2003 待定（共 13571 个，k8s agent 口径）|
