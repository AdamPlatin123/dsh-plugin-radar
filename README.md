...
> 数据截至快照 `20260909T100001Z`（2026-09-09 18:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 19351 · 龄 47m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1264"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
...
- **🔌 Web UI 增强**（2780）— 可用 1341 · 不兼容 418 · 待定 244 · 未测 17 · 监测 760 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2152）— 可用 913 · 不兼容 365 · 待定 191 · 未测 20 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2258）— 可用 814 · 不兼容 285 · 待定 162 · 未测 12 · 监测 985 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（721）— 可用 258 · 不兼容 117 · 待定 57 · 未测 4 · 监测 285 — [明细](catalog/all/消息通讯.md)
...
- **🛠 基建部署**（1362）— 可用 441 · 不兼容 131 · 待定 131 · 未测 4 · 监测 655 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（157）— 可用 38 · 不兼容 7 · 待定 9 · 未测 2 · 监测 101 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7228）— 可用 1827 · 不兼容 375 · 待定 254 · 未测 21 · 监测 4751 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260909T100001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。
