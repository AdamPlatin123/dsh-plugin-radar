...
[![confirmed](https://img.shields.io/badge/confirmed-1350-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13564-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8346** | **3267** | **2087** | **13700** |
...
## 工作原理
> 数据截至快照 `20260925T094501Z`（2026-09-25 17:45:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260925T094501Z` (2026-09-25 17:45:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 23729 · 龄 25m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1350"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13564"}
    D1 -->|"8346 / 3267"| E1["聚合 + README 分类统计"]
    D1 -->|"1951 环境类重试"| C1
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 29013★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1242★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
...
- **🧠 记忆增强**（50）— 可用 15 · 不兼容 4 · 待定 6 · 未测 2 · 监测 23 — [明细](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（22）— 可用 10 · 不兼容 0 · 待定 2 · 未测 7 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（323）— 可用 97 · 不兼容 28 · 待定 19 · 未测 12 · 监测 167 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2837）— 可用 1279 · 不兼容 476 · 待定 265 · 未测 18 · 监测 799 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2225）— 可用 868 · 不兼容 413 · 待定 218 · 未测 23 · 监测 703 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2359）— 可用 784 · 不兼容 341 · 待定 185 · 未测 14 · 监测 1035 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（753）— 可用 246 · 不兼容 138 · 待定 56 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（699）— 可用 262 · 不兼容 107 · 待定 65 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（462）— 可用 170 · 不兼容 47 · 待定 26 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1393）— 可用 418 · 不兼容 160 · 待定 128 · 未测 7 · 监测 680 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（168）— 可用 35 · 不兼容 14 · 待定 8 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7553）— 可用 1821 · 不兼容 426 · 待定 273 · 未测 23 · 监测 5010 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260925T094501Z（2026-09-25 17:45 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8346 可用 · 3267 不兼容 · 1951 待定（共 13564 个，k8s agent 口径）|
