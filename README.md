...
[![运行级可用](https://img.shields.io/badge/运行级可用_8879-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1711-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2859-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
- **🔌 Web UI 增强**（2781）— 可用 1341 · 不兼容 415 · 待定 248 · 未测 17 · 监测 760 — [明细](catalog/all/Web%20UI%20增强.md)
