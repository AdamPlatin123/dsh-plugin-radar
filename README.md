...
[![confirmed](https://img.shields.io/badge/confirmed-1302-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13336-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8708-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1958-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2785-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260911T110001Z`（2026-09-11 19:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 19920 · 龄 108m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1302"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13336"}
    D1 -->|"8708 / 2785"| E1["聚合 + README 分类统计"]
    D1 -->|"1843 环境类重试"| C1
...
- **🎨 主题皮肤**（22）— 可用 12 · 不兼容 0 · 待定 2 · 未测 5 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（310）— 可用 100 · 不兼容 19 · 待定 19 · 未测 8 · 监测 164 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2773）— 可用 1318 · 不兼容 411 · 待定 267 · 未测 17 · 监测 760 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2152）— 可用 895 · 不兼容 355 · 待定 219 · 未测 20 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2261）— 可用 801 · 不兼容 276 · 待定 186 · 未测 12 · 监测 986 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（722）— 可用 256 · 不兼容 115 · 待定 62 · 未测 4 · 监测 285 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（681）— 可用 267 · 不兼容 93 · 待定 66 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（456）— 可用 173 · 不兼容 35 · 待定 33 · 未测 0 · 监测 215 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1359）— 可用 437 · 不兼容 129 · 待定 134 · 未测 4 · 监测 655 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（158）— 可用 37 · 不兼容 7 · 待定 10 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7224）— 可用 1814 · 不兼容 366 · 待定 272 · 未测 21 · 监测 4751 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260911T110001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。
