...
| **累计 / cumulative** | **8598** | **3462** | **1565** | **13625** |
...
## 工作原理
> 数据截至快照 `20260926T111047Z`（2026-09-26 19:10:48 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260926T111047Z` (2026-09-26 19:10:48 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    ...
    C1 --> D1{"判定 · 总 13489"}
    D1 -->|"8598 / 3462"| E1["聚合 + README 分类统计"]
    D1 -->|"1429 环境类重试"| C1
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 29041★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui)** · 284★ — 自研 ANSI 渲染的极简终端 UI
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard)** · 3794★ — 两阶段预设：极简模式对齐启动 → 全量装载（rc.8 实测 ✅）
...
> 渲染于快照 20260926T111047Z（2026-09-26 19:10 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8598 可用 · 3462 不兼容 · 1429 待定（共 13489 个，k8s agent 口径）|
