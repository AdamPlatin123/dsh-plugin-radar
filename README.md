...
[![运行级可用](https://img.shields.io/badge/运行级可用_8891-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1717-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2839-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
- **🔌 Web UI 增强**（2781）— 可用 1334 · 不兼容 415 · 待定 255 · 未测 17 · 监测 760 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2152）— 可用 914 · 不兼容 367 · 待定 189 · 未测 19 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2257）— 可用 813 · 不兼容 281 · 待定 167 · 未测 11 · 监测 985 — [明细](catalog/all/Agent%20能力.md)
...
- **🛠 基建部署**（1361）— 可用 442 · 不兼容 132 · 待定 128 · 未测 4 · 监测 655 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（157）— 可用 38 · 不兼容 8 · 待定 8 · 未测 2 · 监测 101 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7227）— 可用 1827 · 不兼容 374 · 待定 254 · 未测 21 · 监测 4751 — [明细](catalog/all/其他.md)
