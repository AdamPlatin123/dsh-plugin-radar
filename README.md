...
[![运行级可用](https://img.shields.io/badge/运行级可用_8959-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1738-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2750-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
- **🔌 Web UI 增强**（2775）— 可用 1343 · 不兼容 402 · 待定 254 · 未测 17 · 监测 759 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2156）— 可用 926 · 不兼容 354 · 待定 194 · 未测 19 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2255）— 可用 816 · 不兼容 274 · 待定 171 · 未测 11 · 监测 983 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（721）— 可用 261 · 不兼容 112 · 待定 59 · 未测 4 · 监测 285 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（674）— 可用 268 · 不兼容 93 · 待定 58 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（453）— 可用 174 · 不兼容 35 · 待定 31 · 未测 0 · 监测 213 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1360）— 可用 443 · 不兼容 133 · 待定 125 · 未测 4 · 监测 655 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（156）— 可用 36 · 不兼容 9 · 待定 8 · 未测 2 · 监测 101 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7192）— 可用 1834 · 不兼容 369 · 待定 253 · 未测 21 · 监测 4715 — [明细](catalog/all/其他.md)
