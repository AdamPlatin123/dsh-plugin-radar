...
> Data as of snapshot `20260908T061501Z` (2026-09-08 14:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 19038 · age 45m"]
    ...
    B1 -->|"plugins 1176"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 13334"}
    D1 -->|"8919 / 2798"| E1["aggregate + README stats"]
...
- **🛒 市场与管理**（308）— OK 102 · incompatible 19 · pending 17 · untested 8 · watching 162 — [details](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2776）— OK 1341 · incompatible 404 · pending 255 · untested 17 · watching 759 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2155）— OK 916 · incompatible 365 · pending 192 · untested 19 · watching 663 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2253）— OK 818 · incompatible 275 · pending 166 · untested 11 · watching 983 — [details](catalog/all/Agent%20能力.md)
...
- **🛠 基建部署**（1360）— OK 441 · incompatible 133 · pending 127 · untested 4 · watching 655 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（157）— OK 38 · incompatible 8 · pending 8 · untested 2 · watching 101 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7220）— OK 1829 · incompatible 374 · pending 255 · untested 21 · watching 4741 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260908T061501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
