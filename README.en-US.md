...
**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1285 plugin repos indexed** (manifest-level classification, v2 engine), **13335 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260909T171501Z` (2026-09-10 01:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 19432 · age 201m"]
    ...
    B1 -->|"plugins 1285"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
...
- **🔌 Web UI 增强**（2776）— OK 1339 · incompatible 418 · pending 242 · untested 17 · watching 760 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2150）— OK 912 · incompatible 364 · pending 191 · untested 20 · watching 663 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2257）— OK 812 · incompatible 285 · pending 162 · untested 12 · watching 986 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（721）— OK 257 · incompatible 118 · pending 57 · untested 4 · watching 285 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（678）— OK 268 · incompatible 98 · pending 57 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（454）— OK 173 · incompatible 34 · pending 32 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1361）— OK 440 · incompatible 131 · pending 131 · untested 4 · watching 655 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（157）— OK 38 · incompatible 7 · pending 9 · untested 2 · watching 101 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7230）— OK 1829 · incompatible 375 · pending 254 · untested 21 · watching 4751 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260909T171501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
