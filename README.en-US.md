...
[![confirmed](https://img.shields.io/badge/confirmed-1264-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13335-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8880-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1694-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2876-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1264 plugin repos indexed** (manifest-level classification, v2 engine), **13335 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260909T100001Z` (2026-09-09 18:00:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 19351 · age 47m"]
    ...
    B1 -->|"plugins 1264"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 13335"}
    D1 -->|"8880 / 2876"| E1["aggregate + README stats"]
    D1 -->|"1579 env retries"| C1
...
> 人工策展 56 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-09 19:32（UTC+8）。

### 🚀 智力增强 Booster（7）

- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7140★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-annotation](https://github.com/omdsh-dev/dsh-annotation)** · 112★ — 划选文字→批注→随消息发送，回复逐条对照
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 24711★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 3922★ — 生态第一个视觉插件，视觉工作流的基准方案
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-vision-router](https://github.com/ysr666/dsh-vision-router)** · 1091★ — 内置免费视觉模型路由，给文本 agent 装眼睛
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24464★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[mobius](https://github.com/nutshellai-tech/mobius)** · 296★ — 编码增强
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[mnemon](https://github.com/mnemon-dev/mnemon)** · 566★ — 跨 agent、本地优先的持久记忆
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve)** · 293★ — 五轨记忆 + git 分支托管 + 后台自我进化
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 3491★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[petdex](https://github.com/crafter-station/petdex)** · 4059★ — 生态最高星桌宠图鉴
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-09 19:32（UTC+8）。
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7140★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + P1-P23 任务感知推理模式路由（rc.8 实测 ✅）
...
- **🔌 Web UI 增强**（2780）— OK 1341 · incompatible 418 · pending 244 · untested 17 · watching 760 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2152）— OK 913 · incompatible 365 · pending 191 · untested 20 · watching 663 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2258）— OK 814 · incompatible 285 · pending 162 · untested 12 · watching 985 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（721）— OK 258 · incompatible 117 · pending 57 · untested 4 · watching 285 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（676）— OK 266 · incompatible 97 · pending 58 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（454）— OK 173 · incompatible 34 · pending 32 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1362）— OK 441 · incompatible 131 · pending 131 · untested 4 · watching 655 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（157）— OK 38 · incompatible 7 · pending 9 · untested 2 · watching 101 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7228）— OK 1827 · incompatible 375 · pending 254 · untested 21 · watching 4751 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260909T100001Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260909T100001Z（2026-09-09 18:00 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
